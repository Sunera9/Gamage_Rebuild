...
export default function CreateLeave() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log("loading leave ...");
    try {
      console.log("loading leave try");
      ...
      resetForm();
      console.log("loading leave done");
    } catch (error) {
      setMessage(
        `Error: ${error.response ? error.response.data.status : error.message}`
      );
      console.log("loading leave failed");
    }
    console.log("loading leave complete");
  };
